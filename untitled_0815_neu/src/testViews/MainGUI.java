...
//	      for (int j = 0; j < Constants.gamefieldrowcount; j++)
//	      {
//	    	  spielfeld[i][j].styleProperty().bind(viewModel.field()[i][Constants.gamefieldrowcount -1 -j]);
//	      }
//	    }
//	  //Satz Status
//	  //TODO
...
//	      for (int j = 0; j < Constants.gamefieldrowcount; j++)
//	      {
//	    	  spielfeld[i][j].styleProperty().unbindBidirectional(viewModel.field()[i][Constants.gamefieldrowcount -1 -j]);
